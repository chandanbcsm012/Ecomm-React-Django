...
import QuickProductView from "../common/QuickProductView";
...
export class Category extends Component {
  render() {
    return (
      <>
        <Banner title={"Shop Category page"} />
              ...
              <div className="sidebar-categories">
                ...
                <ul className="main-categories">
                  ...
                  <li className="main-nav-list">
                    ...
                    >
                      <span className="lnr lnr-arrow-right"></span>Home and
                      Cleaning<span className="number">(53)</span>
                    </a>
                    <ul
                      className="collapse"
                      id="homeClean"
                  ...
                  <li className="main-nav-list">
                    ...
                    >
                      <span className="lnr lnr-arrow-right"></span>Office
                      Products<span className="number">(77)</span>
                    </a>
                    <ul
                      className="collapse"
                      id="officeProduct"
                  ...
                  <li className="main-nav-list">
                    ...
                    >
                      <span className="lnr lnr-arrow-right"></span>Beauty
                      Products<span className="number">(65)</span>
                    </a>
                    <ul
                      className="collapse"
                      id="beauttyProduct"
                  ...
                  <li className="main-nav-list">
                    ...
                    >
                      <span className="lnr lnr-arrow-right"></span>Health
                      Products<span className="number">(29)</span>
                    </a>
                    <ul
                      className="collapse"
                      id="healthProduct"
                  ...
                  <li className="main-nav-list">
                    ...
                    >
                      <span className="lnr lnr-arrow-right"></span>Home
                      Appliances<span className="number">(15)</span>
                    </a>
                    <ul
                      className="collapse"
                      id="homeAppliance"
